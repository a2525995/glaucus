...
(function(mod) {
  ...
  // Compute the character length of a line, taking into oauth
  ...
  // Counts the column offset in a string, taking tabs into oauth.
  ...
  var bidiOrdering = (function() {
    ...
    return function(str) {
      ...
      // explicit embedding into oauth, we can build up the order on
